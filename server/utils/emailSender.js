...
export const generateEmail = ({
  ...
  return `
        ...
        <p>As part of the onboarding process, please submit your documents for verification through our <strong>Smart HR Portal</strong>. Below are your login credentials:</p>
...
export const otpMsg = (otp) => {
  return `
        ...
        <p><strong>Your Smart HR Portal OTP:</strong></p>
...
export async function sendEmailToEmployee(
  ...
  try {
    ...
    const mailOptions = {
      from: `Smart HR Portal Team <${senderEmail}>`,
      to: receiverEmail,
