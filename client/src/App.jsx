...
import { FiYoutube, FiSun, FiMoon, FiMail } from "react-icons/fi";
...
const SocialLinksPage = () => {
  ...
  const socialLinks = [
    ...
    { name: "Bulk SMS", icon: <FaMailBulk />, url: "#", color: "#1DA1F2" },
    ...
    { name: "Holiday Calender", icon: <SlCalender />, url: "#", color: "#5865F2" },
    { name: "Award", icon: <FaAward />, url: "#", color: "#333" },
